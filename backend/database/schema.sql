...
CREATE TABLE quotation_items (
    ...
    total_price_without_tax DECIMAL(12,2) GENERATED ALWAYS AS (quantity_bidded * unit_price) STORED,
    net_price_with_gst DECIMAL(12,2) GENERATED ALWAYS AS ((quantity_bidded * unit_price) * (1 + gst_percentage / 100)) STORED,
    FOREIGN KEY (quotation_id) REFERENCES quotations(id) ON DELETE CASCADE,
    FOREIGN KEY (rfq_item_id) REFERENCES rfq_items(id) ON DELETE RESTRICT
);
